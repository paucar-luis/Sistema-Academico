...
$res_buscar_periodo_academico = mysqli_fetch_array($busc_periodo_academico);
$id_director = $res_buscar_periodo_academico['id_director'];
                ...
                <form class="form-horizontal form-label-left" method="POST" action="operaciones/actualizar_periodo_academico.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" name="nombre" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_buscar_periodo_academico['nombre']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="date" name="fecha_inicio" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_buscar_periodo_academico['fecha_inicio']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="date" name="fecha_fin" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_buscar_periodo_academico['fecha_fin']; ?>">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <select type="text" id="director" name="director" class="form-control col-md-7 col-xs-12" value='<?php echo $id_director; ?>'>
                        ...
                        while ($res_busqueda_docente = mysqli_fetch_array($buscar_docente)) {
                          $id_busqueda_director = $res_busqueda_docente['id'];
                        ?>
                        <option value="<?php echo $id_busqueda_director; ?>" 
                          <?php if($id_director === $id_busqueda_director){
                            echo "selected";
                          } ?>
                          ><?php echo $res_busqueda_docente['apellidos_nombres']; ?></option>
                          <?php
                          };
                          ?>
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="date" name="fecha_actas" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_buscar_periodo_academico['fecha_actas']; ?>">
                    </div>
                  </div>
                  <div class="ln_solid"></div>
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                      <a class="btn btn-primary" type="button" href="periodo_academico.php">Retroceder</a>
