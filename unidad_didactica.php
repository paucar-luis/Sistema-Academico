											...
											<tr>
												...
												<td>
													<span class="justify-center">
														<a href="editar_unidad_didactica.php?id=<?php echo $res_b_ud['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"> </i> Editar</a>
														<a href="eliminar_unidad_didactica.php?id=<?php echo $res_b_ud['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"> </i> Editar</a>
												</td>
											</tr>
										<?php
										}
