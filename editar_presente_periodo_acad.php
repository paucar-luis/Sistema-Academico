								...
								<div class="x_title">
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="x_panel">
												<div class="x_title">
													<h2>Editar presente periodo académico<small></small></h2>
												...
												<div class="x_content">
													<form class="form-horizontal form-label-left" action="./operaciones/actualizar_presente_periodo_academico.php" method="POST" id="formulario_docente">
														<input type="hidden" name="id" value="<?php echo $id_p_periodo; ?>">
                          ...
                          ?>
														...
														<div class="form-group">
															<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
																<a class="btn btn-primary" href="./presente_periodo_academico.php" type="button">Retrocder</a>
